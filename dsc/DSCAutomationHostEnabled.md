...
---
제목:   DSCAutomationHostEnabled 레지스트리 키 ms.date:  2016-05-16 키워드:  powershell,DSC 설명:  
...
DSC에서는 **HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies** 아래의 **DSCAutomationHostEnabled** 레지스트리 키를 사용하여 초기 부팅 시 컴퓨터를 자동으로 구성합니다.
