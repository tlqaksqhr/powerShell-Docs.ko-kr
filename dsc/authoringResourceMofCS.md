...
<span data-ttu-id="d1e5e-112">다음은 MOF 리소스 정의입니다.</span><span class="sxs-lookup"><span data-stu-id="d1e5e-112">The following is the MOF resource definition.</span></span>
