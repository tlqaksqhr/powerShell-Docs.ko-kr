...
- [Don't Write Scripts, Write PowerShell Modules(스크립트가 아니라 PowerShell 모듈을 작성하세요.)](http://blogs.technet.com/b/heyscriptingguy/archive/2011/06/27/don-t-write-scripts-write-powershell-modules.aspx)
- [Understanding PowerShell Modules(PowerShell 모듈 이해)](http://blogs.technet.com/b/heyscriptingguy/archive/2015/07/10/understanding-powershell-modules.aspx)
