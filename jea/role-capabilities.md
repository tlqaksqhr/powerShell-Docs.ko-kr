...
아래 표는 JEA 세션에서 사용자에게 할당된 두 개의 역할 A와 B를 사용하는 실제 이 논리의 몇 가지 예를 보여 줍니다.

규칙 | 역할 A VisibleCmdlets                                                                          | 역할 B VisibleCmdlets                                                                             | 유효 사용자 권한
-----|------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|----------------------------
1    | `Get-Service`                                                                                  | 해당 없음                                                                                               | `Get-Service`
1    | 해당 없음                                                                                            | `Get-Service`                                                                                     | `Get-Service`
