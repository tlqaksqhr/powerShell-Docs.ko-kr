# <a name="powershell-core-support-lifecycle"></a><span data-ttu-id="c7fcb-101">PowerShell Core 지원 수명 주기</span><span class="sxs-lookup"><span data-stu-id="c7fcb-101">PowerShell Core Support Lifecycle</span></span>
