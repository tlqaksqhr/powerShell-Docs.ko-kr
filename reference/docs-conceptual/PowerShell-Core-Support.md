# <a name="powershell-core-support-lifecycle"></a><span data-ttu-id="ef872-101">PowerShell Core 지원 수명 주기</span><span class="sxs-lookup"><span data-stu-id="ef872-101">PowerShell Core Support Lifecycle</span></span>
