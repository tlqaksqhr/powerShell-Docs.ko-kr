...
---
# <a name="psscheduledjob-module"></a>PSScheduledJob 모듈
이 섹션에는 Windows PowerShell에서 예약된 작업을 관리하는 **PSScheduledJob** 모듈에 대한 도움말 항목이 포함되어 있습니다. 이 모듈은 Windows PowerShell과 함께 설치됩니다.

## <a name="help-topics"></a>도움말 항목
[Windows PowerShell 예약된 작업 Cmdlet](http://go.microsoft.com/fwlink/?LinkID=245864)
