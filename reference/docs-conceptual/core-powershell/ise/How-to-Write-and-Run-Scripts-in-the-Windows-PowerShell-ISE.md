...
2. 스크립트를 만듭니다. Windows PowerShell ISE에서는 구문 색 지정 및 탭 완성 기능을 통해 이러한 작업을 보다 편리하게 수행할 수 있습니다.
...
Windows PowerShell ISE는 ASCII, BigEndianUnicode, 유니코드, UTF32, UTF7, UTF8, 기본값 등의 인코딩 옵션을 지원합니다. 기본값 옵션의 값은 시스템에 따라 다릅니다.
