...
- [Get-Command](/powershell/module/Microsoft.PowerShell.Core/get-command) 사용

- [Cmd.exe](/windows-server/administration/windows-commands/cmd) 및 [UNIX 명령](/windows/wsl/reference) 사용

- [탭 완성 기능 사용](../../core-powershell/console/using-tab-expansion.md)

- [Get-Help 사용](./getting-detailed-help-information.md)
