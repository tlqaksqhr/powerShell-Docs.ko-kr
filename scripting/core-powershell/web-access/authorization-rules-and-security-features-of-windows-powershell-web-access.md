...
<p>이는 웹 서버(IIS)에서 제공되는 추가 보안 설정의 한 예입니다. 기타 IIS 보안 기능에 대한 자세한 내용은 <a href="https://technet.microsoft.com/library/cc731278(ws.10).aspx">웹 서버 보안 구성(IIS 7)</a>을 참조하세요.</p></td>
</tr>
<tr class="even">
<td><p>2</p></td>
