...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="a96f6-102">PowerShellGet을 사용하여 PowerShell 스크립트 검색, 설치 및 관리</span><span class="sxs-lookup"><span data-stu-id="a96f6-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="a96f6-103">WMF 5.0 RTM 릴리스에서는 PowerShell 스크립트 공유 기능이 PowerShellGet에 추가되었습니다.</span><span class="sxs-lookup"><span data-stu-id="a96f6-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="a96f6-104">PowerShell 스크립트를 지원하기 위해 다음과 같은 새 cmdlet이 PowerShell 모듈에 추가됩니다.</span><span class="sxs-lookup"><span data-stu-id="a96f6-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="a96f6-105">스크립트 공유 Cmdlet의 구문:</span><span class="sxs-lookup"><span data-stu-id="a96f6-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
